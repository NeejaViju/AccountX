    ...
    return (
      <div className="cp-company-container">
        <div className="cp-column">
          ...
          <div className={`floating-label-group ${selCompany[0].gstNumber ? "filled" : ""}`}>
          <input
            type="text"
            name="gstNumber"
            placeholder="Enter GST Number"
            className={`address-border ${selCompany[0].gstNumber ? "has-data" : ""}`}
            onChange={handleInputChange}
            value={selCompany[0].gstNumber}
          />
          <label
            htmlFor="gstNumber"
            className={selCompany[0].gstNumber ? "floating" : ""}
          >
            GST Number*
          </label>
        </div>

        <div className={`cp-input-with-dropdown floating-label-group ${selCompany[0].companyType ? "filled" : ""}`}>
              <select
                name="companyType"
                className={`address-border ${selCompany[0].companyType ? "has-data" : ""}`}
                onChange={handleInputChange}
              ...
              <label
                htmlFor="companyType"
                className={selCompany[0].companyType ? "floating" : ""}
              >
                Company Type*
              </label>
            ...
            <div className="cp-row">
            <div className={`floating-label-group ${selCompany[0].companyId ? "filled" : ""}`}>
                <input
                  type="text"
                  name="companyId"
                  placeholder="Company ID"
                  className={`address-border ${selCompany[0].companyId ? "has-data" : ""}`}
                  onChange={handleInputChange}
                  value={selCompany[0].companyID}
                />
                <label
                  htmlFor="companyId"
                  className={selCompany[0].companyId ? "floating" : ""}
                >
                  Company ID
                </label>
              </div>
          ...
          <div className="cp-row">
          <div className={`floating-label-group ${selCompany[0].businessTradeName ? "filled" : ""}`}>
              <input
                type="text"
                name="businessTradeName"
                placeholder="Business Trade Name*"
                className={`address-border ${selCompany[0].businessTradeName ? "has-data" : ""}`}
                onChange={handleInputChange}
              ...
              <label
                ...
                className={selCompany[0].businessTradeName ? "floating" : ""}
              >
                Business Trade Name*
              </label>
            </div>
          ...
          <div className="cp-row">
            ...
            <div className={`cp-input-with-dropdown floating-label-group ${selCompany[0].businessEmail ? "filled" : ""}`}>
              <input
                type="email"
                placeholder="Business Email*"
                className={`address-border ${selCompany[0].businessEmail ? "has-data" : ""}`}
                value={selCompany[0].businessEmail}
                onChange={handleInputChange}
              />
              <label
                htmlFor="businessEmail"
                className={selCompany[0].businessEmail ? "floating" : ""}
              >
                Business Email*
              </label>
            </div>
            <div className={`cp-input-with-icon ${selCompany[0].industry ? "filled" : ""}`}>
  <div className="floating-label-group">
    <input
      type="text"
      placeholder="Industry"
      className={`address-border ${selCompany[0].industry ? "has-data" : ""}`}
    ...
    <label
      ...
      className={selCompany[0].industry ? "floating" : ""}
    >
      Industry
    </label>
              </div>
